...
public class SkiGameWindow extends UIView {
	...
	public SkiGameWindow(Presenter presenter, Display display, int width, int height, String title) {
	...
	void initWidgets() {
		...
		btnSearch.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg0) {	
				...
				SkiGameWindow1 sk1 = new SkiGameWindow1(presenter,null,400,400,"Ski Game");
				sk1.run();
